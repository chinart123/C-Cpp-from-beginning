# Câu hỏi bổ sung cho Constant Expression và Constexpr
...
> **Chốt lại bài học:** Đừng dùng `#define` để định nghĩa hằng số nếu bạn muốn một cuộc đời Debug thanh bình. Hãy dùng `constexpr int MAX_STUDENTS = 30;` để biến này thực sự tồn tại trong bộ nhớ và dễ dàng theo dõi bằng Debugger.s