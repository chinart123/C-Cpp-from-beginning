; ModuleID = 'operand_dangling_check.cpp'
source_filename = "operand_dangling_check.cpp"
...
$_Z7greaterii = comdat any

$_Z17test_dangerous_opi = comdat any

@_ZSt4cout = external global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [61 x i8] c"========== PHAN 1: TINH KHOAN DUNG CUA CONSTEXPR ==========\0A\00", align 1
@.str.1 = private unnamed_addr constant [25 x i8] c"Case 1 (Compile-time) : \00", align 1
@.str.2 = private unnamed_addr constant [14 x i8] c" is greater!\0A\00", align 1
@.str.3 = private unnamed_addr constant [25 x i8] c"Case 2 (Tuy chon)     : \00", align 1
@.str.4 = private unnamed_addr constant [25 x i8] c"Case 3 (Run-time)     : \00", align 1
@.str.5 = private unnamed_addr constant [25 x i8] c"Case 4 - Enter x      : \00", align 1
@_ZSt3cin = external global %"class.std::basic_istream", align 8
@.str.6 = private unnamed_addr constant [25 x i8] c"Case 4 (Run-time)     : \00", align 1
@.str.7 = private unnamed_addr constant [15 x i8] c" is greater!\0A\0A\00", align 1
@.str.8 = private unnamed_addr constant [58 x i8] c"========== PHAN 2: KIEM TRA HANH VI NGUY HIEM ==========\0A\00", align 1
@.str.9 = private unnamed_addr constant [27 x i8] c"--- KIEM TRA RUN-TIME ---\0A\00", align 1
@.str.10 = private unnamed_addr constant [18 x i8] c"Gia tri ban dau: \00", align 1
@.str.11 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@.str.12 = private unnamed_addr constant [37 x i8] c"Ket qua cua (temp_x = temp_x++) la: \00", align 1
@.str.13 = private unnamed_addr constant [3 x i8] c"\0A\0A\00", align 1
@.str.14 = private unnamed_addr constant [31 x i8] c"--- KIEM TRA COMPILE-TIME ---\0A\00", align 1
@.str.15 = private unnamed_addr constant [23 x i8] c"Ket qua Compile-time: \00", align 1
...
define dso_local noundef i32 @main() #0 {
  ...
  %9 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) %8, i32 noundef 9)
  ...
  %12 = call noundef i32 @_Z7greaterii(i32 noundef 5, i32 noundef 6)
  ...
  %17 = call noundef i32 @_Z7greaterii(i32 noundef %16, i32 noundef 6)
  ...
  %20 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.5)
  ...
  %24 = call noundef i32 @_Z7greaterii(i32 noundef %23, i32 noundef 6)
  ...
  %31 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.10)
  ...
  %39 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.14)
  store i32 5, ptr %6, align 4
  %40 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef @.str.15)
  ...
  %42 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %41, ptr noundef @.str.11)
  ret i32 0
}
...
define linkonce_odr dso_local noundef i32 @_Z7greaterii(i32 noundef %0, i32 noundef %1) #2 comdat {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
; Function Attrs: mustprogress noinline nounwind optnone uwtable
define linkonce_odr dso_local noundef i32 @_Z17test_dangerous_opi(i32 noundef %0) #2 comdat {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
